...
class SentimentNetwork:
    ...
    def init_network(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # self.output_nodes**-0.5 => self.hidden_nodes**-0.5
...
class SentimentNetwork:
    ...
    def train(self, training_reviews_raw, training_labels):
        # indices to decrease complexity
        ...
        for i in range(len(training_reviews)):
            ...
            # update weights_0_1 according to index
            for index in review:
    ...
    def run(self, review):
        # because of no update_input_layer, conduct layer_1 here
        self.layer_1 *= 0
        unique_indices = set()
...
class SentimentNetwork:
    def __init__(self, reviews, labels, min_count=10, polarity_cutoff=0.1, hidden_nodes = 10, learning_rate = 0.1):
        # new polarity_cutoff and min_count
        np.random.seed(1)
        self.pre_process_data(reviews, labels, polarity_cutoff, min_count)
        self.init_network(len(self.review_vocab),hidden_nodes, 1, learning_rate)

    def pre_process_data(self, reviews, labels, polarity_cutoff, min_count):
        # new pos_neg_ratios, polarity_cutoff and min_count
        positive_counts = Counter()
        negative_counts = Counter()
        total_counts = Counter()
        for i in range(len(reviews)):
